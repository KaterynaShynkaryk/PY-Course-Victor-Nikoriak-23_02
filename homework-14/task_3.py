# Напиши декоратор arg_rules, який перевіряє аргументи, передані функції.
# Декоратор повинен приймати 3 параметри:
# max_length: 15 – максимальна довжина аргументу
# type_: str – тип аргументу
# contains: [] – список символів, які аргумент має містити
# Якщо будь-яка перевірка не пройшла, функція повинна повернути False та надрукувати причину
# помилки; інакше – повернути результат функції.
